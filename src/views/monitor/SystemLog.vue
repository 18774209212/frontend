<template>
  <a-card :bordered="false" class="card-area">
    ...
    <div>
      <div class="operator">
        <a-button v-hasPermission="'admin:log:delete'" @click="batchDelete" type="primary" ghost>删除</a-button>
        <a-dropdown v-hasPermission="'admin:log:export'">
          <a-menu slot="overlay">
  ...
  methods: {
    ...
    batchDelete () {
      ...
      this.$confirm({
        ...
        centered: true,
        onOk () {
          that.$delete('admin/log/' + that.selectedRowKeys.join(',')).then(() => {
