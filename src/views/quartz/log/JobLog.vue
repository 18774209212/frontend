<template>
  <a-card :bordered="false" class="card-area">
    ...
    <div>
      <div class="operator">
        <a-button v-hasPermission="'admin:jobLog:delete'" @click="batchDelete" type="primary" ghost>删除</a-button>
        <a-dropdown v-hasPermission="'admin:jobLog:export'">
          <a-menu slot="overlay">
  ...
  methods: {
    ...
    batchDelete () {
      ...
      this.$confirm({
        ...
        centered: true,
        onOk () {
          that.$delete('admin/job/log/' + that.selectedRowKeys.join(',')).then(() => {
    ...
    exprotExccel () {
      ...
      this.$export('admin/job/log/excel', {
        sortField: sortField,
        sortOrder: sortOrder,
        ...this.queryParams,
        ...filteredInfo
